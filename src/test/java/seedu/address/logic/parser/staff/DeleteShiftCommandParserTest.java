...
public class DeleteShiftCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        // valid input
        assertParseSuccess(parser, userInput, new DeleteShiftCommand(targetIndex,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteShiftCommand.MESSAGE_USAGE);
