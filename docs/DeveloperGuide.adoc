...
When the `statsdtime` command is entered, the current statistis of the amount of bookings is to be displayed to the user in the form of a bar chart.
...
The _Sequence Diagram_ given above shows how the components interact with each other for the scenario where the user issues the command `statstime 10`.
