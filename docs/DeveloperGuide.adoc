...
When the `statstime` command is entered, the current statistis of the amount of bookings is to be displayed to the user in the form of a bar chart, where each bar corresponds to the number of customers in a particular time of the day.
...
When the `statsdays` command is entered, the current statistis of the amount of bookings is to be displayed to the user in the form of a bar chart, where each bar corresponds to the number of customers between certain dates.
