...
(Assuming that at this point, the restaurant book is empty.)
...
.    `addrecipe r/cheese fries iq/1&1 iq/2&1`
     ...
     • There are 20 slices of cheese for 20 servings of cheese fries, but only 10 packets of fries for 10 servings of cheese fries.
...
.  `restockingredient i/2 q/10`
    ...
    • Now, there are 20 slices of cheese for 20 servings of cheese fries, and 20 packets of fries for 20 servings of cheese fries.
