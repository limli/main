...
.When the restaurant is full, a message indicating the next available timeslot will be shown. Note that this is only an example and this message will not appear unless the relevant data is loaded.
